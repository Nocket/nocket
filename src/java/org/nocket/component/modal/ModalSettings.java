...
/**
 * A ModalSettings describes the function and appearance of a confirm, indo or error dialog.
 * <br>
 * For a confirmation dialog:<br> 
 * The buttons in the confirmation dialog can be defined in the standard way (ok and no) or
 * they can be defined by up to three ButtonDefs. A @see org.nocket.component.modal.ModalSettings.ButtonDef
...
public class ModalSettings extends ModalPageSettings {
    ...
    public ModalSettings(String title, String text, ButtonFlag... buttons) {
        super(title);
        this.text = text;
        this.flags = Arrays.asList(buttons);
        this.keyOrTexts = null;
    }

    public ModalSettings(String title, String text, ButtonDef... buttonDefs) {
        super(title);
        this.text = text;
        this.keyOrTexts = new ArrayList<String>();
        this.flags = new ArrayList<ButtonFlag>();
