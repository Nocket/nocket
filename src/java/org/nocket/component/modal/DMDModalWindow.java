...
public class DMDModalWindow extends Panel {
	...
	private void showModalMessagePanel(String title, String defaultTitleKey, String text, ModalCallback callback, ButtonDef... buttonDefs) {
		ModalSettings settings = new ModalSettings(title, text, buttonDefs);
		showModalMessagePanel(settings, defaultTitleKey, callback);
	}

	private void showModalMessagePanel(String title, String defaultTitleKey, String text, ModalCallback callback, ButtonFlag... buttonFlags) {
