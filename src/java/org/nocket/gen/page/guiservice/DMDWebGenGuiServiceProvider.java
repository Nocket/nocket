...
public class DMDWebGenGuiServiceProvider implements WebGuiServiceI, Serializable {
    ...
    /**
     * Modalen Dialog wenn m�glich von oberster Page laden
     * @param ctx
     * @return
     */
    ...
    private void openModalConfirm(final DMDWebGenPageContext ctx, final AbstractModalWindow modal) {
        ...
        ModalCallback modalCallback = new ModalCallback() {
            ...
            public boolean doAction(AjaxRequestTarget target, ButtonFlag flag) {
                 ...
                 * muss das mitgeteilt werden. Boolean.TRUE sorgt daf�r, dass
                 * genau dann das Schlieߟen des Modal Windows verhindert wird,
                 * damit nachfolgend im ModalWindow eingereichte Panels auch
                 * angezeigt werden.
                 */
                return webGuiServiceProvider.activeShowModalPanelConfig == null;
            }
        };
