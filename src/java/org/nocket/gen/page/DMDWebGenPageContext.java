...
import org.nocket.gen.domain.visitor.registry.DomainRegistryVisitor;
import org.nocket.gen.page.element.ModalElement;
import org.nocket.gen.page.element.synchronizer.SynchronizerHelper;
import org.nocket.gen.page.element.synchronizer.error.AjaxAlertMethodExceptionHandler;
import org.nocket.gen.page.element.synchronizer.error.MethodExceptionHandlerI;
import org.nocket.gen.page.guiservice.TouchedRegistry;
import org.nocket.gen.page.guiservice.TouchedRegistryData;
import org.nocket.gen.page.visitor.bind.ComponentRegistry;
import org.nocket.gen.page.visitor.bind.builder.BindingInterceptor;
import org.nocket.gen.page.visitor.registry.PageRegistry;
...
public class DMDWebGenPageContext implements Serializable {
    ...
    public DMDWebGenPageContext(MarkupContainer page) {
        this.page = page;
        if (org.nocket.page.DMDWebPage.class.isAssignableFrom(page.getClass())) {
